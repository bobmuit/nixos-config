...
deployasus:
    rsync -avz ~/nixos-config/ bobmuit@nixos-asus:/home/bobmuit/nixos-config/ && \
    ssh bobmuit@nixos-asus "sudo nixos-rebuild switch --flake /home/bobmuit/nixos-config#nixos-asus"
